...
public class LoopWithIterator {
    public static void main(String[] args) {
        ...
        Iterator<Integer> it = nums.iterator(); //isaret koymus gibi düsün.
        ...
        //System.out.println("it.next() = " + it.next()); // pointer sona geldiginden exception veriyor. tekrar baslamak
                                                        // icin tekrar object olusturmaliyiz.
        ...
        for(String city : cities) { //by for each loop object can not be removed
